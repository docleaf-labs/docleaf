...
Docleaf allows you to integrate your technical code and API oriented documentation with your user facing long form 
documentation. It is an extension to the Sphinx documentation system that pulls in technical details about your
code as generated by Doxygen and formats the information to seamlessly integrate with your long form docs.
